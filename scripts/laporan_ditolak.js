// Arsip Laporan Table
function initLaporanDitolak() {
  const sel = '#tbl-ditolak';
        ...
        columns: [
          ...
          },
          {
            ...
            <div class="d-flex flex-wrap justify-content-center">
                <a href="#detail" data-ticket="${encodeURIComponent(ticket)}" data-backload="laporan_ditolak" class="btn btn-sm w-100 w-lg-0 mb-2 bg-primary text-white detail">DETAIL</a>
            </div>`
          },
        ],
        language: {
