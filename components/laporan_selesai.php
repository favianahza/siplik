...
<section class="content-header py-3 border-bottom">
  <div class="container-fluid d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-2">
    <h1 class="m-0 fw-bold">Laporan Selesai</h1>
    ...
    <div class="card border-0 shadow-sm">
      <div class="card-body">
        <div class="d-flex align-items-center justify-content-between mb-2">
          <div class="fw-semibold">Tabel List Laporan yang sudah diselesaikan oleh anda</div>
          <div class="small text-muted">Limit: <span id="dt-limit">10</span></div>
        </div>

        <div class="table-responsive">
          <table id="tbl-laporan-selesai" class="table table-striped table-hover w-100" data-fetch-limit="1000">
