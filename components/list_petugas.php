...
<section class="content-header py-3 border-bottom">
  <div class="container-fluid d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-2">
    <h1 class="m-0 fw-bold">List Petugas</h1>
    ...
    <div class="card border-0 shadow-sm">
      <div class="card-body">
        <div class="d-flex align-items-center justify-content-between mb-2">
          <div class="fw-semibold">List Petugas saat ini</div>
          <div class="small text-muted">Limit: <span id="dt-limit">10</span></div>
        </div>

        <div class="table-responsive">
          <table id="tbl-petugas" class="table table-striped table-hover w-100" data-fetch-limit="1000">
            <thead class="table-light">
              <tr>
                <th style="width:60px">No.</th>
                <th>Nama</th>
                <th>Email</th>
                <th>Jumlah Pengaduan yang diproses</th>
              </tr>
            </thead>
            <tbody></tbody>
          </table>
